...
export default {
  ...
  SIGNIN_HEADING: 'Continue With KodCanvas',
  SIGNIN_SUBHEADING: 'To use KodCanvas you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using KodCanvas, you agree to the collection of usage data for analytics.',
